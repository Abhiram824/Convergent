...
export default function BasicButtons() {
  return (
    ...
    <Stack spacing={12} direction="row" justifyContent="flex-end"> 
      ...
      <LoginButton component={Link} to ="Login" variant="contained" sx={ { borderRadius: 3, fontFamily:"Open Sans" } }>Login</LoginButton>
      <SignUp component={Link} to ="Signup" variant="contained" sx={ { borderRadius: 3, fontFamily:"Open Sans" } }>Sign up</SignUp>
    </Stack>
  );
}